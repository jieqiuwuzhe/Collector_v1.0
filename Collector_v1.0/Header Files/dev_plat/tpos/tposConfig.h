...
#define configMAX_PRIORITIES                          ( 3 )//优先级数目，此数越大RAM消耗越大
...
#define configTIMER_TASK_PRIORITY                 ( configMAX_PRIORITIES - 1 ) //软定时器优先级设为最高
#define configTIMER_QUEUE_LENGTH                  ( 10 ) //定时器命令队列长度10
#define configTIMER_TASK_STACK_DEPTH              ( configMINIMAL_STACK_SIZE )//分配给定时器任务内存大小
