...
#ifndef INC_TPOS_H
	#error "include tpos.h must appear in source files before include timers.h"
#endif
 ...
 * INCLUDE_xTimerGetTimerDaemonTaskHandle is set to 1 in tposConfig.h.
 *
 ...
 * configTIMER_TASK_PRIORITY in tposConfig.h) is higher than the priority of
